...
def run(cfg):
    ...
    write(dest/'JUDGE_ACCOUNT.json',dict(cumulative=read(common/'public/BUDGET_LEDGER.json')['new_judgment_items_dispatched'],this_phase=read(common/'public/BUDGET_LEDGER.json')['24C_items_dispatched']))
