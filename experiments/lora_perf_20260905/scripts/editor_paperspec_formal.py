    ...
    *,
    ...
    if method == "lora" and expected.get("profile_name"):
        lora_config = LoraRuntimeConfig(
            ...
            rank=int(expected.get("rank", 16)),
            alpha=int(expected.get("lora_alpha", 16)),
            layer_scope=expected.get("layer_scope", "all"),
            target_modules=tuple(expected.get("target_modules", ("gate_proj", "up_proj", "down_proj"))),
