# Stage18: full FACT/EXTRA implementation and two-edit smoke
...
CPU check: `PYTHONPATH=. python -m unittest discover -s tests -p test_stage18_cfact.py -v` (7 checks). Original core tests and lossless transfer test are inherited. Regression source identities are fictional. GPU smoke was executed from private implementation commit `0d54456c96742c1e8d32aef5976c4d55030e9077`; acceptance/pilot construction were subsequent read-only CPU work.
