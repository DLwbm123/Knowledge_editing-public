...
def publish(root):
    ...
    if read(public/'RUN_AUTHORIZATION.json').get('pure_only'):
        prefix='experiments/medtrace_stage19_pure_20260918';report='reports/medtrace_stage19_pure_20260918'
    ...
    if read(public/'RUN_AUTHORIZATION.json').get('pure_only'):names+=['stage19_pure_audit','test_stage19_pure']
