...
@dataclass
class LiveEditMultimodalHparams(HyperParams):
    device: Any = 0
    alg: str = "LiveEdit"
    ...
    def from_hparams(cls, hparams_name_or_path: str):
        ...
        assert alg == "LIVEEDIT" or print(
            f"LiveEditMultimodalHparams can not load from {hparams_name_or_path}, alg_name is {config.get('alg_name')}"
        )
        config.setdefault("alg", "LiveEdit")
